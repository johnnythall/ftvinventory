...
ActiveRecord::Schema.define(version: 20141212193043) do
  ...
  add_index "assets", ["permission_id"], name: "index_assets_on_permission_id"
  ...
  add_index "rentals", ["asset_id"], name: "index_rentals_on_asset_id"
